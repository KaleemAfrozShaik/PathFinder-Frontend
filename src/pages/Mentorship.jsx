      ...
      <div className="flex flex-col w-full max-w-[960px]">
        ...
        <div className="p-4 space-y-4">
          {mentors.map((mentor, index) => (
            <div
              key={index}
              className="flex flex-col md:flex-row items-stretch justify-between gap-4 rounded-lg bg-white p-4 shadow-[0_0_4px_rgba(0,0,0,0.1)]"
            >
              <div className="flex-[2_2_0px] flex flex-col gap-4">
                ...
                <button className="flex w-fit items-center justify-center rounded-lg h-8 px-4 bg-[#f0f2f5] text-[#111418] text-sm font-medium">
                  Request Session
                </button>
              </div>
              <div
